...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-180.000000, -66.163000, 179.999999, 86.805000],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([93.820708, -15.801101, 142.171245, 10.870436], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA SESAR INDONESIA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (583 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Proyeksi Peta Geografis: Datum Horizontal WGS 1984 (Spheroid Nasional Indonesia)<br /><br />SUMBER DATA<br />1. Data Sesar: Pusat Studi Gempa Nasional (PusGen) 2024, Pusat Survei Geologi (PSG) 2024, Philippine Institute of Volcanology and 	  Seismology, The GEM Global Active Faults Database.<br />2. Slab2 - A Comprehensive Subduction Zone Geometry Model: USGS Asset Identifier Service (AIS).<br />3. Topography: General Bathymetric Chart of the Oceans.<br />4. Batas Administrasi Indonesia: Badan Informasi Geospasial (BIG).<br />5. Peta Dasar: Esri, TomTom, Garmin, FAO, NOAA, USGS; Esri, GEBCO, Garmin, NaturalVue.';
            }
